...
setInterval(() => {
  http.get(`http://namiksyst.glitch.me/`);
}, 280000);
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'hi') {  //WESO#0001
      msg.reply('** hello my friend   :sparkling_heart:**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'fuck') {  //WESO#0001
      msg.reply('**fuck you**');  //WESO#0001
    }
  });


client.on('message', msg => {  //WESO#0001
    if (msg.content === 'i love you') {  //WESO#0001
      msg.reply('**gay**');  //WESO#0001
    }
  });
  

  client.on('message', msg => {  //WESO#0001
    if (msg.content === 'hello') {  //WESO#0001
      msg.reply('**hi bro**');  //WESO#0001
    }
  });
   ...
   client.on('message', msg => {  //WESO#0001
    if (msg.content === 'wassup') {  //WESO#0001
      msg.reply('**ma nigga :heart: **');  //WESO#0001
    }
  });
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' ̅ĸ̅α̅ω̅ĸ̅α̅в ̅и̅α̅м̅ɪ̅ĸ Is The Best ','Just Do It'];
    var i = -1;
    var j = 0;
...
client.on('message', function(msg) {
  if(msg.content.startsWith ('-kanchof')) {
...
client.login('Njg0NDcwNjg2NTI5NzQ5MDY1.XuphBQ.jYZ9O52W-QlbrvSjttui6KUgIf8');
